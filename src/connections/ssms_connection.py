## used for connecting to SQL Server Management Studio (SSMS) using pyodbc
# This script fetches data from a specified table in a SQL Server database and returns it as a pandas DataFrame.
import pyodbc
import pandas as pd
import json
import os
